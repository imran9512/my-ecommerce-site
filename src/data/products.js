...
const products = [
...

  {
    ...
    tags: ["Modiwake 100 mg, Dowvigil pakistan, Dowvigil Tablet price in pakistan, MODALERT 100 price in pakistan, Dowvigil 200mg price in pakistan, Modiwake 100 mg price in pakistan, Modafinil price in pakistan, Dowvigil Tablet Uses in urdu"],
...

  {
    ...
    longDesc: "If you need lisdexamfetamine in Pakistan, our pharmacy is here to help. We provide genuine medication to support those managing ADHD or binge eating disorder. With easy delivery, you can order from us knowing you’ll receive a dependable product. Please talk to your doctor before ordering.",
    specialNote: "",
    related: ["003",
      "V50",
      "V70"],
