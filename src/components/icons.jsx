...
// ====== SOLID ICONS (jo tum ne manga tha) ======
...
export const BuildingStorefrontIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const XMarkIcon = (props) => (
  ...
  >
    <path
      ...
      d="m4.5 18.75 15-15m0 15-15-15"
    />
  </svg>
);

// ShoppingCartIcon (outline)
export const ShoppingCartIconOutline = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
// StarIconSolid (solid/filled version)
export const StarIconSolid = (props) => (
...
// StarIconHalf
export function StarIconHalf({ percent = 50, ...props }) {
