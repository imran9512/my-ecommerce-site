  ...
  return (
   ...
   >
     <Image
       ...
       width={600}
       height={400}
       className="w-full h-auto object-cover cursor-pointer shrink-0"
       onClick={() => window.open(`${images[currentImg]}?v=2`, '_blank')}
       priority
     />
     </div>
          ...
          {images.length > 1 && (
            <>
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 rounded-full p-2 shadow-lg bg-white/70 hover:bg-white hidden sm:flex"
              >
                <ChevronLeftIcon className="h-6 w-6 text-gray-800" />
              </button>
              <button
                onClick={(e) => { e.stopPropagation(); nextImg(); }}
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white rounded-full p-2 shadow-lg hidden sm:flex"
              >
          ...
          <div className="flex justify-center gap-2 mt-3 overflow-x-auto">
            {images.map((img, idx) => (
              <button
                ...
                className={`w-16 h-16 sm:w-18 sm:h-18 shrink-0 border-2 rounded overflow-hidden
        ...
        <div className="w-full">
          ...
          <div className="mt-4 flex flex-row items-center space-x-3">
            ...
            <button
              ...
              className="flex items-center justify-center space-x-1.5 px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600"
            >
