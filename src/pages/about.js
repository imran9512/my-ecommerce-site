...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About Us | Aap Ki Sehat</title>
        <link rel="canonical" href={canonical('/about')} />
      </Head>
      <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800 leading-relaxed">
        <h1 className="text-3xl font-bold text-center text-sky-600 mb-2">About Us 🌟</h1>

        <h2 className="text-2xl font-semibold text-sky-500 mt-2 mb-2">Our Mission 🚀</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-sky-500 mt-2 mb-2">Quality Assurance ✅</h2>
        <p className="mb-2">
        ...
        <h2 className="text-xl font-semibold text-sky-500 mt-2 mb-2">A Customer-Centric Approach 💖</h2>
        <p className="mb-2">
        ...
        <h2 className="text-2xl font-semibold text-sky-500 mt-2 mb-2">Online-Only Convenience 💻</h2>
        ...
        <h2 className="text-2xl font-semibold text-sky-500 mt-2 mb-2">Our Values 🌈</h2>
        <ul className="list-disc list-inside mb-2 space-y-1">
        ...
        <h2 className="text-2xl font-semibold text-sky-500 mt-2 mb-2">Join Our Community 🤝</h2>
        <p className="mb-2">
          Follow us on socials for health tips, flash sales & member perks. Become part of the <strong>{SITE_NAME}</strong> family today!
        </p>

        <h2 className="text-2xl font-semibold text-sky-500 mt-2 mb-2">Conclusion 🎉</h2>
